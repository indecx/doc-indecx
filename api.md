...
A comunicação será realizada através da seguinte URL:
```bash
https://indecx.com/v2/send-blocklist
```
## **Request**
```bash
{
...
```bash
{
  https://indecx.com/v2/blocklist-info?[params]
}
```
## Query Params
| Params  | Descrição |
...
![Badge](https://img.shields.io/badge/PUT-.v2%2Ffeedback--follow--ups-blue)
...
```bash
https://indecx.com/v2/feedback-follow-ups
```
...
```javascript
PUT /v2/feedback-follow-ups HTTP/1.1
Host: indecx.com
Content-Type: application/json
...
## **Request (Exemplo company-key / v2)**

```javascript
PUT /v2/feedback-follow-ups HTTP/1.1
Host: indecx.com
Content-Type: application/json
company-key: eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJwdWJsaWNLZXkiOiIkMmIkMTAkQkxWNENfghghjgj...
